/**
 * Execute on-chain resize for the stuck channel 0xd25a with proof state
 */
...
async function main() {
  ...
  console.log('\nChannel USDC balance:', (chBal as any)[0].toString());
  ...
  console.log('Alice Custody USDC:', (acctBal as any)[0][0].toString());
}
